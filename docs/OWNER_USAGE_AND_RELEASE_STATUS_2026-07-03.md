# SplashLens Owner Usage And Release Status - 2026-07-03

## Usage Notifications

Live app-owner surfaces checked on 2026-07-03:
...
- `https://app.splashlens.com/api/events?digest=1` returned `401 Unauthorized`, which matches the intended auth gate for the digest path rather than a public outage.
...
Marketing, intake, and discovery surfaces checked live on 2026-07-03:

- `https://splashlens.com` returned HTTP `200`.
- `https://app.splashlens.com` returned HTTP `200`.
- `https://splashlens.com/api/partner-intake` returned `{"ok":true,"endpoint":"splashlens_partner_intake","storageConfigured":true,"emailConfigured":true}`.
...
- `https://app.splashlens.com/ai.txt` now serves a real plain-text SplashLens app AI-discovery file. The July 1 regression where this path returned the HTML app shell appears resolved as of 2026-07-03.

## Store Status

Public store surfaces checked live on 2026-07-03:

- Public Google Play listing URL resolved at `https://play.google.com/store/apps/details?id=com.splashlens.fieldtools`.
- The Play listing body still exposed live markers consistent with the current public package and privacy policy link.
...
Live checkout verification on 2026-07-03:
