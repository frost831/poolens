# SplashLens Owner Usage And Release Status - 2026-07-17

## Usage Notifications

Live owner-surface checks on 2026-07-17:
...
Marketing, intake, and discovery surfaces checked live on 2026-07-17:
...
- `https://splashlens.com/ai.txt`, `https://splashlens.com/llms.txt`, `https://splashlens.com/robots.txt`, `https://splashlens.com/sitemap.xml`, and `https://splashlens.com/privacy` all returned HTTP `200`.
...
Public store surfaces checked live on 2026-07-17:

- Public Google Play listing URL resolved at `https://play.google.com/store/apps/details?id=com.splashlens.fieldtools`.
- The fetched Play listing body still exposed markers consistent with package `com.splashlens.fieldtools`, public version `1.0.5`, and privacy policy `https://splashlens.com/privacy`.
...
- Public iOS truth is now aligned to `1.0.6`, matching the local release line more closely than Play.

## Stripe

Live checkout verification on 2026-07-17:
...
Outreach state checked on 2026-07-17:

- Gmail searches since the prior completed run found no new SplashLens unsubscribe/remove request, complaint, bounce, or delivery-failure message.
- Service Industry News created a new warm thread: Carolyn Dibrell replied on 2026-07-16 saying SplashLens looks interesting and asked to discuss marketing support, and Joshua replied on 2026-07-17 to arrange a call after 9 AM Hawaii time.
- The checked-in `tools/splashlens_outreach_day_lock.ps1 -Date 2026-07-17` guard returned `BLOCKED` because recent hard-bounce/delivery-failure language still exists inside the last seven days of the run log.
...
- Warm press and publisher threads can continue manually, but the automated cold lane should stay paused.
