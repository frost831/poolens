...
- Apple public lookup for `https://apps.apple.com/us/app/splashlens/id6763644905` still returned the live `SplashLens` listing with bundle `com.splashlens.app`, version `1.0.4`, and `currentVersionReleaseDate` `2026-07-11T00:44:23Z`.
...
- Current public iOS truth remains the `id6763644905` listing at version `1.0.4`.
...
Outreach state checked on 2026-07-15:

- Gmail targeted stop-signal and recent-recipient history checks found no new SplashLens reply, unsubscribe/remove request, complaint, or delivery-failure message after the prior completed run.
- Same-day Gmail sent-mail search returned zero SplashLens messages on `2026-07-15`.
