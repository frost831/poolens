# SplashLens Owner Usage And Release Status - 2026-07-13

## Usage Notifications

Live app-owner surfaces checked on 2026-07-13:
...
- The owner dashboard route is publicly reachable through the redirect chain, but the current public truth is still the redirect rather than a direct `200`.

## Site, Intake, And Discovery

Marketing, intake, and discovery surfaces checked live on 2026-07-13:
...
Public store surfaces checked live on 2026-07-13:
...
Live checkout verification on 2026-07-13:

- `https://app.splashlens.com/api/checkout?plan=monthly` redirected to `https://buy.stripe.com/7sY7sE2aIaq31cE5EF8AE0O`.
- `https://app.splashlens.com/api/checkout?plan=yearly` redirected to `https://buy.stripe.com/aFa28k9Da69NdZq3wx8AE0P`.
- Public checkout mode remains `payment_link_direct`, and following both redirects still lands on live Stripe Checkout pages.
