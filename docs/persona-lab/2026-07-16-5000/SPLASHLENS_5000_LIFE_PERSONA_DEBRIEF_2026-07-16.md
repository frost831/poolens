...
The modeled fix bundle raises expected first-value completion from **61% to 78%**, expected wow from **36.6% to 64.9%**, and love score from **65.9 to 84.2** while reducing modeled time-to-value from **89.3s to 63.6s**. These are synthetic counterfactual estimates, not measured customer outcomes.
